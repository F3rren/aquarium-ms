...
public class InhabitantServiceImpl implements InhabitantService {
    ...
    private static final Logger log = LoggerFactory.getLogger(InhabitantServiceImpl.class);
    ...
    public InhabitantServiceImpl(InhabitantRepository inhabitantRepository, SpeciesClient speciesClient, InhabitantMapper inhabitantMapper) {
