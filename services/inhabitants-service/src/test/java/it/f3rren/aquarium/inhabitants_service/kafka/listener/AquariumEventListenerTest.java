...
class AquariumEventListenerTest {
    ...
    class OnAquariumEvent {
        ...
        @Test
        void deletesInhabitantsWhenEventIsDeleted() {
            AquariumEvent event = new AquariumEvent(42L, "DELETED");

            listener.onAquariumEvent(event);

            verify(inhabitantRepository).deleteAllByAquariumId(42L);
        }
        ...
        void doesNothingWhenEventIsCreated() {
            ...
            verify(inhabitantRepository, never()).deleteAllByAquariumId(any());
        }
    ...
    @Test
    void resourceDescriptionIsInhabitants() {
        assertEquals("inhabitants", listener.getResourceDescription());
    }
}
