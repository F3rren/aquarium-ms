...
@Service
public class ManualParameterServiceImpl implements ManualParameterService {

    private static final Logger log = LoggerFactory.getLogger(ManualParameterServiceImpl.class);

    private final ManualParameterRepository manualParameterRepository;

    public ManualParameterServiceImpl(ManualParameterRepository manualParameterRepository) {
