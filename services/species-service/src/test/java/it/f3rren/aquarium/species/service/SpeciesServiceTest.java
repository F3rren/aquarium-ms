...
class SpeciesServiceTest {
    ...
    private final Coral sampleCoral = new Coral(1L, "Hammer Coral", "Euphyllia ancora", "LPS", 100, 30,
            Difficulty.MEDIUM, LightRequirement.MEDIUM, FlowRequirement.MEDIUM, CoralPlacement.MIDDLE,
            false, CoralFeeding.OCCASIONAL, "A popular LPS coral");
    ...
    class GetAllFish {
        ...
        @Test
        void returnsDtoList() {
            Fish f2 = new Fish(2L, "Tang", "Acanthuridae", "Acanthuridae", 200, 40,
                    Difficulty.MEDIUM, true, FishTemperament.SEMI_AGGRESSIVE, FishDiet.HERBIVORE, null, null, WaterType.MARINE);
    ...
    class GetAllCorals {
        ...
        @Test
        void returnsDtoList() {
            Coral c2 = new Coral(2L, "Torch Coral", "Euphyllia glabrescens", "LPS", 100, 25,
                    Difficulty.MEDIUM, LightRequirement.LOW, FlowRequirement.LOW, CoralPlacement.BOTTOM,
                    false, CoralFeeding.OCCASIONAL, "A flowing LPS coral");
