...
@Service
public class TargetParameterServiceimpl implements TargetParameterService {

    private static final Logger log = LoggerFactory.getLogger(TargetParameterServiceimpl.class);

    private final TargetParameterRepository targetParameterRepository;

    public TargetParameterServiceimpl(TargetParameterRepository targetParameterRepository) {
