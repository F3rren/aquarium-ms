...
public class CreateAquariumDTO {
    ...
    /**
     * Name of the aquarium. This field is required and must be between 2 and 100
     * characters.
     */
    ...
    /**
     * Volume of the aquarium in liters. Must be a positive number no greater than
     * 100,000.
     */
    @Positive(message = "Volume must be positive")
    @Max(value = 100000, message = "Volume cannot exceed 100000 liters")
    private int volume;
    ...
    /**
     * Description of the aquarium. This field is optional and must be at most 500
     * characters.
     */
    ...
    /**
     * Image URL of the aquarium. Optional, must be a valid http/https URL if
     * provided.
     */
    @URL(protocol = "http,https", message = "Image URL must be a valid http/https URL")
